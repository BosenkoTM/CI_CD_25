...
### Критерии оценки:
- Корректность работы фронтенд-приложения (6 балла).
- Корректность работы бэкенд-приложения (6 балла).
- Правильность контейнеризации приложения с помощью Docker (6 балла).
- Правильность создания манифестов Kubernetes (6 балла).
- Успешное развертывание приложения в кластере Kubernetes (6 балла).
