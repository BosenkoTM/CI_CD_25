...
## Лабораторная работа 5. Создание и развертывание полнофункционального приложения
...
### Критерии оценки:
- Корректность работы фронтенд-приложения (4 балла).
- Корректность работы бэкенд-приложения (4 балла).
- Правильность контейнеризации приложения с помощью Docker (4 балла).
- Правильность создания манифестов Kubernetes (4 балла).
- Успешное развертывание приложения в кластере Kubernetes (4 балла).
...
Вариант 18. Создайте приложение "Система управления членством" с использованием `Vue.js, `Node.js`, `Express` и `MySQL`.
