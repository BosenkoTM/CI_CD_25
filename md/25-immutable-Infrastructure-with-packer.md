...
## Практическая работа 5.1. Создание неизменяемой инфраструктуры с использованием Packer
...
### Критерии оценки:
- Правильность установки и настройки `Packer` (2 балла).
- Корректность создания шаблона `Packer` (3 балла).
- Успешная сборка образа виртуальной машины (3 балла).
- Работоспособность созданного образа виртуальной машины (1 балл).
